			...
			<div id="myGallery">
				...
				if($featured_posts_category != '' && $featured_posts_category != '0') {
					...
					for($i = 1; $i <=5; $i++) {
						?>
							<div class="imageElement">
								<h3>Este é um destaque <?php echo $i; ?> title</h3>
								<p>Para configurar o destque, por favor, vá até a página opções do tema em wp-admin. Você também pode desativar posts destaque se não quiser exibi-los.</p>
